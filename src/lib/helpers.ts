/**
 *  ts-debounce
 *  copied from https://github.com/chodorowicz/ts-debounce/blob/master/src/index.ts
 */
...
export function scaleWidth(natWidth: number, natHeight: number, itemHeight: number) {
